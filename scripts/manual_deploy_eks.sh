# This file build and deploy frontend for EKS environment
...
kubectl set image -n ${NAMESPACE} deployment/uniframe-${DEPLOY_ENV}-frontend-deployment frontend=${ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/${FRONTEND_REPO}:${IMAGE_TAG}